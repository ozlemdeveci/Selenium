...
//		waitForClickability(element);
	...
	/**
	 * This methods selects date from the calender which is defined in the HRMS
	 * application
	 * 
	 * @param element
	 * @param year
	...
	/**
	 * this method will slecet value from dd
	 * @param element
	 * @param index
	 */
	public static void selectDDText(WebElement element, int index) {
		Select select = new Select(element);
		List<WebElement> options = select.getOptions();
		boolean isFound=false;
		...
		if (!isFound) {
			System.out.println("Value with index "+index+ " is not selected");
		}
	}
